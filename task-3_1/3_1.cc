 ...
 * @file 3_1.cc
 * @author Леонард Пак
 * @brief Реализовать очередь с динамическим зацикленным буфером, обрабатывающую
 * команды push* и pop*.В первой строке количество команд n. n ≤ 1000000. Каждая
 * команда задаётся как 2 целых числа: a b. a = 2 - pop front, a = 3 - push
 * back. Команда добавления элемента 3 задана с неотрицательным параметром
 * b. Если дана команда pop*, то число b - ожидаемое значение. Если команда pop
